...
class OrderController extends GetxController {
  ...
  Future<void> updateOrderStatusWithDetails(
    ...
    try {
      // SupabaseService ব্যবহার করে অর্ডার আপডেট করুন
      final existingOrder =
      ...
      // fetchOrders(); // Stream ব্যবহার করায় ম্যানুয়ালি রিফ্রেশ করার প্রয়োজন নেই
  ...
  Future<void> updatePaymentStatus(String orderId, bool isSuccess) async {
    try {
      // SupabaseService ব্যবহার করে পেমেন্ট স্ট্যাটাস আপডেট করুন
      final existingOrder =
          allOrders.firstWhere((order) => order.orderId == orderId);
      final updatedOrder = existingOrder.copyWith(
